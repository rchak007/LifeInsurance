...
async function main() {
  ...
  await claimCommission(acc2, account2, publicClient);
}

async function claimCommission(_acc: any, _account: any, _publicClient: any) {
  console.log(
    "Investor Account that's doing Claim Commission - ",
